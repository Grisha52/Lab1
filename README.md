...
|-------------|--------------------|-----------------|----------------|
| X (Число 1) | Вещественное число | 2<sup>-32</sup> | 10<sup>9</sup> |
| Y (Число 2) | Вещественное число | 2<sup>32</sup>  | 10<sup>9</sup> |
...
graph TD
    ...
    B --> C[/Создаем массив num из целых чисел a, b, c, d/]
    C --> D[/Сортирока чисел/]
    D --> E[/Вывод 3-его элемента массива num/]
    E --> F([Конец])
```
...
public class Main {
    ...
    public static void main(String[] args) {
        // Считывание четырех целых чисел a, b, c и d из консоли
        int a = in.nextint();
        int b = in.nextint();
        int c = in.nextint();
        int d = in.nextint();
